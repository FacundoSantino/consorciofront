...
class ReclamosAdmin extends Component{
            ...
            <main className='clase'>
                  <div className='caja'>
                      <div className='tituloLogoPerfil'>
                          ...
                          <h1>Reclamos</h1>
                          <Link to="/bienvenidaadmin"><img src={flecha} className="boton"/> </Link> 
                      </div>
                      <div className='items'>
                          <div className='item'>
                              <img src={crear}/>
                              <Link to="/generarreclamo"><button className='boton'>Generar</button> </Link>
                          </div>
                        
                          <div className='item'>
                              <img src={leer}/>
                              <Link to="/buscarreclamo"><button className='boton'>Buscar</button> </Link>
                          </div>
                      </div>
                  </div>
             </main>
